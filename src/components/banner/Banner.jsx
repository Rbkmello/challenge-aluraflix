    ...
    return (
        <main id="banner" className={styles.layer} style={{ backgroundImage: `url(${banner})`, '--primary-color': primaryColor }}>
            ...
            <section className={styles.content}>
                ...
                Este desafio é uma forma de aprendizado. É um mecanismo onde você poderá se comprometer na resolução de um problema para poder aplicar todos os conhecimentos adquiridos na formação React.
                </p>
